...
<body>
    <?php include './AdminComponents/SideBar.php' ?>
    <div class="container">
        <?php include './AdminComponents/Overview.php' ?>
        <?php include './AdminComponents/RecentCustomers.php' ?>
        <?php include './AdminComponents/Messages.php' ?>
    </div>
