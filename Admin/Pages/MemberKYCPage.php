        ...
        document.addEventListener('DOMContentLoaded', () => {
            fetch('../DataFiles/members_kyc_data.json')
                ...
                <td>
                    ...
                    <button onclick="confirmDelete(${row.member_id}, '${row.name}')" class="btn btn-danger shadow-sm m-1"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
