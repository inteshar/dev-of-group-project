...
<body>
    ...
    <div class="container">
        ...
        <h1 class="pb-0 p-2">Manage Members</h1>
        <div class="manage-member shadow">
            <div class="bg-primary-subtle rounded p-1">
                <button type="button" class="btn btn-warning ms-3 mt-2 shadow-sm fw-bold" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add Member</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            fetch('../DataFiles/members_data.json')
                ...
                <td class="table-row">${row.relative}</td>
                <td class="table-row">${row.relation}</td>
                <td class="table-row">${row.ref_name}</td>
